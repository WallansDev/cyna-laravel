    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center g-4">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 purple-header text-center" style="border: none;">
                    <div class="card-body py-4">
                        ...
                        <a href="{{ route('profile.edit') }}" class="btn btn-success w-100">Modifier informations du
                            compte</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 purple-header text-center" style="border: none;">
                    <div class="card-body py-4">
                        <i class="fa-solid fa-map-marker-alt mb-3" style="font-size: 2.5rem;"></i>
                        <h5 class="card-title mb-3">Adresses de facturation</h5>
                        <a href="{{ route('billing-addresses.index') }}" class="btn btn-success w-100">Gérer mes
                            adresses</a>
                    </div>
                </div>
            </div>
